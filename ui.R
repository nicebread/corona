...
shinyUI(fluidPage(theme = shinytheme("spacelab"),
	...
	fluidRow(
		...
		column(8,
			...
			<li>The exponential curve which you can fit to the data is <i>not</i> an epistemiological model (although in early stages an epidemic can show exponential growth). Importantly, the projection of the exponential curve is <i>not</i> a proper epidemiological forecast of the development. For a more refined simulation based on the SIR model, see this <a href="https://alhill.shinyapps.io/COVID19seir/?fbclid=IwAR2aXJT79M2AmZxMdy8jsiEuSC4i7ijU8Av6oB4dmlZIeJ2VQgL7Tt3QGxA">interactive app</a>.</li>
			</ul>	
			'),
