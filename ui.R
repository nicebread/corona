...
shinyUI(fluidPage(theme = shinytheme("spacelab"),
	...
	fluidRow(
		...
		column(8,
			...
			<li>Between-country <b>comparisons of deaths and death rates are also problematic</b>. For example, <a href="https://twitter.com/G_House__MD/status/1238485575591698433?s=20">Germany does not do post-mortem testing</a> for Covid-19, while Italy [citation needed] and <a href="https://www.cdc.gov/coronavirus/2019-ncov/hcp/guidance-postmortem-specimens.html">USA</a> seem to do that. This might explain the huge differences in death rates between Germany, Italy, and other countries.</li>
			...
			<li>Related to the previous point: <b>Case-fatality risks</b> (i.e., "How many of the sick people die?") <b>are notoriously hard to calculate</b> and prone to many biases (<a href="https://journals.plos.org/plosntds/article?id=10.1371/journal.pntd.0003846">Lipsitch et al., 2015</a>).</li>
			<li><b>Demographics differ between countries / affected regions</b>. It has been argued that <a href="https://www.wired.com/story/why-the-coronavirus-hit-italy-so-hard/">Italy has been hit hard</a> because it has a comparably old population (in particular the affected regions).</li>
			<li>The exponential curve which you can fit to the data is <i>not</i> an epidemiological model (although in early stages an epidemic can show exponential growth). Importantly, the projection of the exponential curve is <i>not</i> a proper epidemiological forecast of the development. For a more refined simulation based on the SIR model, see this <a href="https://alhill.shinyapps.io/COVID19seir/?fbclid=IwAR2aXJT79M2AmZxMdy8jsiEuSC4i7ijU8Av6oB4dmlZIeJ2VQgL7Tt3QGxA">interactive app</a>.</li>
			</ul>	
			'),
